import { Mail, CheckCircle, XCircle, Store, FileText, Package, Sparkles, ArrowRight } from "lucide-react";
...
const MyAccount = () => {
  ...
  return (
    <div className="min-h-screen w-full px-5 py-10 flex justify-center bg-gradient-to-b from-white to-slate-100/40">
      <div className="w-full max-w-4xl space-y-10 animate-fadeIn">
        ...
        <div className="space-y-1">
          ...
          <p className="text-slate-500 text-sm">Manage your profile, plan & identity</p>
        </div>

        {/* PROFILE CARD */}
        <div className="group rounded-2xl border border-white/40 shadow-xl bg-white/70 backdrop-blur-2xl p-6 transition-all hover:shadow-2xl hover:-translate-y-1">
          ...
          {/* Email Section */}
          <div className="mt-6 flex items-center justify-between bg-white/90 border border-white/60 shadow-sm rounded-xl p-4">
            <div className="flex items-center gap-3">
              <Mail className="w-5 h-5 text-indigo-600" />
              <span className="text-slate-700 text-sm">johndoe@gmail.com</span>
            ...
            {!isVerified && (
              <button
                ...
                className="px-3 py-1.5 text-xs rounded-lg bg-gradient-to-r from-blue-500 to-indigo-600 text-white font-medium shadow hover:opacity-90 transition"
              >
                Verify Email
              </button>
            )}
        ...
        <div className="rounded-2xl border border-white/40 shadow-xl bg-white/70 backdrop-blur-2xl p-7 space-y-8 hover:shadow-2xl transition-all hover:-translate-y-1">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className="px-3 py-1.5 rounded-md bg-gradient-to-r from-blue-600 to-indigo-600 text-white text-xs font-semibold shadow">
              Basic Plan
            </span>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <PlanStat icon={<Store className="w-5 h-5" />} label="Stores" value="1 / 4" />
            <PlanStat icon={<FileText className="w-5 h-5" />} label="Pages" value="1 / 5" />
            <PlanStat icon={<Package className="w-5 h-5" />} label="Products" value="1 / 100" />
          </div>

          {/* More Details */}
          <div className="space-y-2">
            <p className="text-sm text-slate-600 leading-relaxed">
              Your current plan allows you to create up to <span className="font-medium text-slate-700">4 stores</span>,  
              <span className="font-medium text-slate-700"> 5 pages</span>, and  
              <span className="font-medium text-slate-700"> 100 products</span>.  
            ...
            <div className="mt-4 p-4 rounded-xl bg-slate-50 border text-sm shadow-inner flex items-center justify-between">
              <div>
                ...
                <p className="font-semibold text-slate-800">March 28, 2025</p>
              </div>
            ...
            <div className="mt-4 p-4 rounded-xl bg-gradient-to-r from-blue-50 to-indigo-50 border shadow-sm flex items-center justify-between">
              <div>
                <p className="text-sm text-slate-600">Recommended Next Plan</p>
